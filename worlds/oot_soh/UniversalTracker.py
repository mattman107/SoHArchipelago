...
def setup_options_from_slot_data(world: "SohWorld") -> None:
    if hasattr(world.multiworld, "re_gen_passthrough"):
        if "Ship of Harkinian" in world.multiworld.re_gen_passthrough:
            ...
            world.options.rainbow_bridge_greg_modifier.value = world.passthrough[
                "rainbow_bridge_greg_modifier"]
            world.options.rainbow_bridge_stones_required.value = world.passthrough[
                "rainbow_bridge_stones_required"]
            world.options.rainbow_bridge_medallions_required.value = world.passthrough[
                "rainbow_bridge_medallions_required"]
            world.options.rainbow_bridge_dungeon_rewards_required.value = world.passthrough[
                "rainbow_bridge_dungeon_rewards_required"]

            world.options.rainbow_bridge_dungeons_required.value = world.passthrough[
            ...
            world.options.shuffle_ocarina_buttons.value = world.passthrough[
            ...
            world.options.shuffle_freestanding_items.value = world.passthrough[
                "shuffle_freestanding_items"]
            world.options.shuffle_shops.value = world.passthrough["shuffle_shops"]
            world.options.shuffle_shops_item_amount.value = world.passthrough[
            ...
            world.options.shuffle_frog_song_rupees.value = world.passthrough[
            ...
            world.options.shuffle_dungeon_rewards.value = world.passthrough[
                "shuffle_dungeon_rewards"]
            world.options.maps_and_compasses.value = world.passthrough["maps_and_compasses"]
            world.options.ganons_castle_boss_key.value = world.passthrough[
                "ganons_castle_boss_key"]
            world.options.ganons_castle_boss_key_greg_modifier.value = world.passthrough[
                "ganons_castle_boss_key_greg_modifier"]
            world.options.ganons_castle_boss_key_stones_required.value = world.passthrough[
                "ganons_castle_boss_key_stones_required"]
            world.options.ganons_castle_boss_key_medallions_required.value = world.passthrough[
                "ganons_castle_boss_key_medallions_required"]
            world.options.ganons_castle_boss_key_dungeon_rewards_required.value = world.passthrough[
                "ganons_castle_boss_key_dungeon_rewards_required"]
            world.options.ganons_castle_boss_key_dungeons_required.value = world.passthrough[
            ...
            world.options.rocs_feather.value = world.passthrough["rocs_feather"]
            ...
            world.options.slingbow_break_beehives.value = world.passthrough[
                "slingbow_break_beehives"]
            ...
            world.options.shuffle_tycoon_wallet.value = world.passthrough.get(
                "shuffle_tycoon_wallet", 1)
            world.options.enable_all_tricks.value = world.passthrough.get(
                "enable_all_tricks", 0)
            world.options.tricks_in_logic.value = world.passthrough.get(
                "tricks_in_logic", set())
            world.options.item_pool.value = world.passthrough.get(
                "item_pool", 0)
            world.options.shuffle_bean_souls.value = world.passthrough.get("shuffle_bean_souls", False)
