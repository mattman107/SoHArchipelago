...
item_data_table: dict[Items, SohItemData] = {
    ...
    Items.KOKIRI_SWORD: SohItemData(1, IC.progression | IC.useful, 0, child_only=True, tags=GroupTag.Sword | GroupTag.Melee_Weapon),
    Items.MASTER_SWORD: SohItemData(2, IC.progression | IC.useful, 0, adult_only=True, tags=GroupTag.Sword | GroupTag.Melee_Weapon),
    Items.GIANTS_KNIFE: SohItemData(3, IC.progression, 0, adult_only=True, tags=GroupTag.Sword | GroupTag.Melee_Weapon),
    Items.BIGGORONS_SWORD: SohItemData(4, IC.progression | IC.useful, 1, adult_only=True, tags=GroupTag.Sword | GroupTag.Melee_Weapon),
    ...
    Items.MIRROR_SHIELD: SohItemData(7, IC.progression | IC.useful, 1, adult_only=True, tags=GroupTag.Shield),
    Items.GORON_TUNIC: SohItemData(8, IC.progression | IC.useful, 1, adult_only=True, tags=GroupTag.Tunic),
    Items.ZORA_TUNIC: SohItemData(9, IC.progression | IC.useful, 1, adult_only=True, tags=GroupTag.Tunic),
    Items.IRON_BOOTS: SohItemData(10, IC.progression | IC.useful, 1, adult_only=True, tags=GroupTag.Boots),
    Items.HOVER_BOOTS: SohItemData(11, IC.progression | IC.useful, 1, adult_only=True, tags=GroupTag.Boots),
    Items.BOOMERANG: SohItemData(12, IC.progression | IC.useful, 1, child_only=True, tags=GroupTag.Ranged_Weapon | GroupTag.Stun_Weapon | GroupTag.Item_Retriever),
    Items.LENS_OF_TRUTH: SohItemData(13, IC.progression | IC.useful, 1, item_type=ItemType.magic, tags=GroupTag.Magic_Item | GroupTag.Secret_Finder),
    Items.MEGATON_HAMMER: SohItemData(14, IC.progression | IC.useful, 1, adult_only=True, tags=GroupTag.Melee_Weapon),
    Items.STONE_OF_AGONY: SohItemData(15, IC.progression | IC.useful, 1, tags=GroupTag.Secret_Finder),
    Items.DINS_FIRE: SohItemData(16, IC.progression, 1, item_type=ItemType.magic, tags=GroupTag.Magic_Item | GroupTag.Magic_Spell),
    Items.FARORES_WIND: SohItemData(17, IC.progression, 1, item_type=ItemType.magic, tags=GroupTag.Magic_Item | GroupTag.Magic_Spell),
    Items.NAYRUS_LOVE: SohItemData(18, IC.progression, 1, item_type=ItemType.magic, tags=GroupTag.Magic_Item | GroupTag.Magic_Spell),
    Items.FIRE_ARROW: SohItemData(19, IC.progression, 1, adult_only=True, item_type=ItemType.magic, tags=GroupTag.Magic_Arrows | GroupTag.Magic_Item),
    Items.ICE_ARROW: SohItemData(20, IC.progression | IC.useful, 1, adult_only=True, item_type=ItemType.magic, tags=GroupTag.Magic_Arrows | GroupTag.Magic_Item),
    Items.LIGHT_ARROW: SohItemData(21, IC.progression, 1, adult_only=True, item_type=ItemType.magic, tags=GroupTag.Magic_Arrows | GroupTag.Magic_Item),
    Items.GERUDO_MEMBERSHIP_CARD: SohItemData(22, IC.progression, 0, tags=GroupTag.Gerudo_Fortress_Item),
    Items.MAGIC_BEAN: SohItemData(23, IC.progression, 0, child_only=True, tags=GroupTag.Beans),
    Items.MAGIC_BEAN_PACK: SohItemData(24, IC.progression, 0, child_only=True, tags=GroupTag.Beans),
    Items.DOUBLE_DEFENSE: SohItemData(25, IC.useful, 1, tags=GroupTag.Health_Upgrade),
    Items.WEIRD_EGG: SohItemData(26, IC.progression, 0, child_only=True, tags=GroupTag.Trade_Item),
    Items.ZELDAS_LETTER: SohItemData(27, IC.progression, 0, child_only=True, tags=GroupTag.Trade_Item | GroupTag.Letter),
    Items.POCKET_EGG: SohItemData(28, IC.progression, 0, adult_only=True, tags=GroupTag.Trade_Item),
    Items.COJIRO: SohItemData(29, IC.progression, 0, adult_only=True, tags=GroupTag.Trade_Item),
    Items.ODD_MUSHROOM: SohItemData(30, IC.progression, 0, adult_only=True, tags=GroupTag.Trade_Item),
    Items.ODD_POTION: SohItemData(31, IC.progression, 0, adult_only=True, tags=GroupTag.Trade_Item),
    Items.POACHERS_SAW: SohItemData(32, IC.progression, 0, adult_only=True, tags=GroupTag.Trade_Item),
    Items.BROKEN_GORONS_SWORD: SohItemData(33, IC.progression, 0, adult_only=True, tags=GroupTag.Trade_Item),
    Items.PRESCRIPTION: SohItemData(34, IC.progression, 0, adult_only=True, tags=GroupTag.Trade_Item),
    Items.EYEBALL_FROG: SohItemData(35, IC.progression, 0, adult_only=True, tags=GroupTag.Trade_Item),
    Items.WORLDS_FINEST_EYEDROPS: SohItemData(36, IC.progression, 0, adult_only=True, tags=GroupTag.Trade_Item),
    Items.CLAIM_CHECK: SohItemData(37, IC.progression, 1, adult_only=True, tags=GroupTag.Trade_Item),
    ...
    Items.STRENGTH_UPGRADE: SohItemData(40, IC.progression | IC.useful, 3, tags=GroupTag.Ability_Upgrade),
    Items.PROGRESSIVE_BOMB_BAG: SohItemData(41, IC.progression | IC.useful, 3, tags=GroupTag.Explosives_Upgrade | GroupTag.Bag_Upgrade),
    Items.PROGRESSIVE_BOW: SohItemData(42, IC.progression | IC.useful, 3, tags=GroupTag.Ranged_Weapon),
    Items.PROGRESSIVE_SLINGSHOT: SohItemData(43, IC.progression | IC.useful, 3, tags=GroupTag.Ranged_Weapon ),
    Items.PROGRESSIVE_WALLET: SohItemData(44, IC.progression, 2, tags=GroupTag.Wallet),
    Items.PROGRESSIVE_SCALE: SohItemData(45, IC.progression | IC.useful, 2, tags=GroupTag.Movement_Upgrade | GroupTag.Ability_Upgrade),
    Items.PROGRESSIVE_NUT_CAPACITY: SohItemData(46, IC.progression | IC.useful, 2, tags=GroupTag.Stun_Weapon | GroupTag.Bag_Upgrade),
    Items.PROGRESSIVE_STICK_CAPACITY: SohItemData(47, IC.progression | IC.useful, 2, tags=GroupTag.Melee_Weapon | GroupTag.Bag_Upgrade),
    Items.BOMBCHU_BAG: SohItemData(48, IC.progression | IC.useful, 0, tags=GroupTag.Explosives_Upgrade | GroupTag.Bag_Upgrade),
    Items.PROGRESSIVE_MAGIC_METER: SohItemData(49, IC.progression | IC.useful, 2, tags=GroupTag.Magic_Meter | GroupTag.Ability_Upgrade),
    ...
    Items.ZELDAS_LULLABY: SohItemData(66, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    Items.EPONAS_SONG: SohItemData(67, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    Items.SARIAS_SONG: SohItemData(68, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    Items.SUNS_SONG: SohItemData(69, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song | GroupTag.Graveyard_Item),
    Items.SONG_OF_TIME: SohItemData(70, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    Items.SONG_OF_STORMS: SohItemData(71, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    Items.MINUET_OF_FOREST: SohItemData(72, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    Items.BOLERO_OF_FIRE: SohItemData(73, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    Items.SERENADE_OF_WATER: SohItemData(74, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    Items.REQUIEM_OF_SPIRIT: SohItemData(75, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    Items.NOCTURNE_OF_SHADOW: SohItemData(76, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    Items.PRELUDE_OF_LIGHT: SohItemData(77, IC.progression | IC.useful, 0, item_type=ItemType.song, tags=GroupTag.Song),
    ...
    Items.FOREST_TEMPLE_BOSS_KEY: SohItemData(98, IC.progression, 1, tags=GroupTag.Boss_Key | GroupTag.Key | GroupTag.Forest_Temple_Item),
    Items.FIRE_TEMPLE_BOSS_KEY: SohItemData(99, IC.progression, 1, tags=GroupTag.Boss_Key | GroupTag.Key | GroupTag.Fire_Temple_Item),
    Items.WATER_TEMPLE_BOSS_KEY: SohItemData(100, IC.progression, 1, tags=GroupTag.Boss_Key | GroupTag.Key | GroupTag.Water_Temple_Item),
    Items.SPIRIT_TEMPLE_BOSS_KEY: SohItemData(101, IC.progression, 1, tags=GroupTag.Boss_Key | GroupTag.Key | GroupTag.Spirit_Temple_Item),
    Items.SHADOW_TEMPLE_BOSS_KEY: SohItemData(102, IC.progression, 1, tags=GroupTag.Boss_Key | GroupTag.Key | GroupTag.Shadow_Temple_Item),
    Items.GANONS_CASTLE_BOSS_KEY: SohItemData(103, IC.progression, 0, tags=GroupTag.Boss_Key | GroupTag.Key | GroupTag.Ganons_Castle_Item),
    Items.FOREST_TEMPLE_SMALL_KEY: SohItemData(104, IC.progression, 5, tags=GroupTag.Small_Key | GroupTag.Key | GroupTag.Forest_Temple_Item),
    Items.FIRE_TEMPLE_SMALL_KEY: SohItemData(105, IC.progression, 8, tags=GroupTag.Small_Key | GroupTag.Key | GroupTag.Fire_Temple_Item),
    Items.WATER_TEMPLE_SMALL_KEY: SohItemData(106, IC.progression, 6, tags=GroupTag.Small_Key | GroupTag.Key | GroupTag.Water_Temple_Item),
    Items.SPIRIT_TEMPLE_SMALL_KEY: SohItemData(107, IC.progression, 5, tags=GroupTag.Small_Key | GroupTag.Key | GroupTag.Spirit_Temple_Item),
    Items.SHADOW_TEMPLE_SMALL_KEY: SohItemData(108, IC.progression, 5, tags=GroupTag.Small_Key | GroupTag.Key | GroupTag.Shadow_Temple_Item),
    Items.BOTTOM_OF_THE_WELL_SMALL_KEY: SohItemData(109, IC.progression, 3, tags=GroupTag.Small_Key | GroupTag.Key | GroupTag.Bottom_of_the_Well_Item),
    Items.TRAINING_GROUND_SMALL_KEY: SohItemData(110, IC.progression, 9, tags=GroupTag.Small_Key | GroupTag.Key | GroupTag.Traning_Ground_Item),
    ...
    Items.GANONS_CASTLE_SMALL_KEY: SohItemData(112, IC.progression, 2, tags=GroupTag.Small_Key | GroupTag.Key | GroupTag.Ganons_Castle_Item),
    Items.TREASURE_GAME_SMALL_KEY: SohItemData(113, IC.progression, 0, tags=GroupTag.Small_Key | GroupTag.Key),
    Items.FOREST_TEMPLE_KEY_RING: SohItemData(114, IC.progression, 0, tags=GroupTag.Key_Ring | GroupTag.Key | GroupTag.Forest_Temple_Item),
    Items.FIRE_TEMPLE_KEY_RING: SohItemData(115, IC.progression, 0, tags=GroupTag.Key_Ring | GroupTag.Key | GroupTag.Fire_Temple_Item),
    Items.WATER_TEMPLE_KEY_RING: SohItemData(116, IC.progression, 0, tags=GroupTag.Key_Ring | GroupTag.Key | GroupTag.Water_Temple_Item),
    Items.SPIRIT_TEMPLE_KEY_RING: SohItemData(117, IC.progression, 0, tags=GroupTag.Key_Ring | GroupTag.Key | GroupTag.Spirit_Temple_Item),
    Items.SHADOW_TEMPLE_KEY_RING: SohItemData(118, IC.progression, 0, tags=GroupTag.Key_Ring | GroupTag.Key | GroupTag.Shadow_Temple_Item),
    Items.BOTTOM_OF_THE_WELL_KEY_RING: SohItemData(119, IC.progression, 0, tags=GroupTag.Key_Ring | GroupTag.Key | GroupTag.Bottom_of_the_Well_Item),
    Items.TRAINING_GROUND_KEY_RING: SohItemData(120, IC.progression, 0, tags=GroupTag.Key_Ring | GroupTag.Key | GroupTag.Traning_Ground_Item),
    ...
    Items.GANONS_CASTLE_KEY_RING: SohItemData(122, IC.progression, 0, tags=GroupTag.Key_Ring | GroupTag.Key | GroupTag.Ganons_Castle_Item),
    ...
    Items.BOMBCHUS_10: SohItemData(149, IC.filler, 3, tags=GroupTag.Consumable_Item),
    Items.BOMBCHUS_20: SohItemData(150, IC.filler, 1, tags=GroupTag.Consumable_Item),
    ...
    Items.PHANTOM_GANONS_SOUL: SohItemData(198, IC.progression, 0, tags=GroupTag.Boss_Soul | GroupTag.Forest_Temple_Item),
    Items.VOLVAGIAS_SOUL: SohItemData(199, IC.progression, 0, tags=GroupTag.Boss_Soul | GroupTag.Fire_Temple_Item),
    Items.MORPHAS_SOUL: SohItemData(200, IC.progression, 0, tags=GroupTag.Boss_Soul | GroupTag.Water_Temple_Item),
    Items.BONGO_BONGOS_SOUL: SohItemData(201, IC.progression, 0, tags=GroupTag.Boss_Soul | GroupTag.Shadow_Temple_Item),
    Items.TWINROVAS_SOUL: SohItemData(202, IC.progression, 0, tags=GroupTag.Boss_Soul | GroupTag.Spirit_Temple_Item),
    Items.GANONS_SOUL: SohItemData(203, IC.progression, 0, tags=GroupTag.Boss_Soul | GroupTag.Ganons_Castle_Item),
    Items.OCARINA_A_BUTTON: SohItemData(204, IC.progression, 0, tags=GroupTag.Ocarina_Button),
    Items.OCARINA_CUP_BUTTON: SohItemData(205, IC.progression, 0, tags=GroupTag.Ocarina_Button),
    Items.OCARINA_CDOWN_BUTTON: SohItemData(206, IC.progression, 0, tags=GroupTag.Ocarina_Button),
    Items.OCARINA_CLEFT_BUTTON: SohItemData(207, IC.progression, 0, tags=GroupTag.Ocarina_Button),
    Items.OCARINA_CRIGHT_BUTTON: SohItemData(208, IC.progression, 0, tags=GroupTag.Ocarina_Button),
    Items.SKELETON_KEY: SohItemData(209, IC.progression, 0, tags=GroupTag.Key),
    Items.FISHING_POLE: SohItemData(210, IC.progression, 0, tags=GroupTag.Item_Retriever),
    ...
    Items.GUARD_HOUSE_KEY: SohItemData(251, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.MARKET_BAZAAR_KEY: SohItemData(252, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.MARKET_POTION_SHOP_KEY: SohItemData(253, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.MASK_SHOP_KEY: SohItemData(254, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.MARKET_SHOOTING_GALLERY_KEY: SohItemData(255, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.BOMBCHU_BOWLING_KEY: SohItemData(256, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.TREASURE_CHEST_GAME_BUILDING_KEY: SohItemData(257, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.BOMBCHU_SHOP_KEY: SohItemData(258, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.RICHARDS_HOUSE_KEY: SohItemData(259, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.ALLEY_HOUSE_KEY: SohItemData(260, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.KAK_BAZAAR_KEY: SohItemData(261, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.KAK_POTION_SHOP_KEY: SohItemData(262, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.BOSS_HOUSE_KEY: SohItemData(263, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.GRANNYS_POTION_SHOP_KEY: SohItemData(264, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.SKULLTULA_HOUSE_KEY: SohItemData(265, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.IMPAS_HOUSE_KEY: SohItemData(266, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.WINDMILL_KEY: SohItemData(267, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.KAK_SHOOTING_GALLERY_KEY: SohItemData(268, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.DAMPES_HUT_KEY: SohItemData(269, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.TALONS_HOUSE_KEY: SohItemData(270, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.STABLES_KEY: SohItemData(271, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.BACK_TOWER_KEY: SohItemData(272, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.HYLIA_LAB_KEY: SohItemData(273, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.FISHING_HOLE_KEY: SohItemData(274, IC.progression, 0, tags=GroupTag.Overworld_Key | GroupTag.Key),
    Items.DISTANT_SCARECROW: SohItemData(275, IC.progression, 0, adult_only=True),
    Items.ROCS_FEATHER: SohItemData(276, IC.progression, 0, tags=GroupTag.Movement_Upgrade),
