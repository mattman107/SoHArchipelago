...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.WASTELAND_NEAR_FORTRESS, world, [
        (Regions.GF_OUTSIDE_GATE, lambda bundle: True, SOHOverworldEntranceNames.HAUNTED_WASTELAND_EAST_EXIT, SOHEntranceGroups.OVERWORLD | SOHEntranceGroups.BOTH_AGE),
    ...
    connect_regions(Regions.WASTELAND_NEAR_COLOSSUS, world, [
        (Regions.DESERT_COLOSSUS, lambda bundle: True, SOHOverworldEntranceNames.HAUNTED_WASTELAND_WEST_EXIT, SOHEntranceGroups.OVERWORLD | SOHEntranceGroups.BOTH_AGE),
