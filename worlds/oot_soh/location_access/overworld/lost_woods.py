...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.LW_FOREST_EXIT, world, [
        (Regions.KOKIRI_FOREST, lambda bundle: True_()),
    ])
    ...
    add_events(Regions.LOST_WOODS, world, [
        ...
        (EventLocations.LW_BEAN_PLANT_FAIRY, Events.CAN_ACCESS_FAIRIES,
         lambda bundle: is_child(bundle) & can_use(Items.MAGIC_BEAN, bundle) & can_use(Items.SONG_OF_STORMS,
                                                                                           bundle)),
    ...
    add_locations(Regions.LOST_WOODS, world, [
        ...
        (Locations.LW_DEKU_SCRUB_NEAR_BRIDGE,
         lambda bundle: is_child(bundle) & can_stun_deku(bundle) & can_afford_slot(Locations.LW_DEKU_SCRUB_NEAR_BRIDGE, bundle)),
        ...
        (Locations.LW_UNDERWATER_SHORTCUT_RUPEE1,
         lambda bundle: is_child(bundle) & (has_item(Items.SILVER_SCALE, bundle) | can_use(Items.IRON_BOOTS, bundle) | can_use(Items.BOOMERANG, bundle))),
    ...
    connect_regions(Regions.LOST_WOODS, world, [
        (Regions.LW_FOREST_EXIT, lambda bundle: True_()),
        (Regions.GC_WOODS_WARP, lambda bundle: True_()),
        (Regions.LW_BRIDGE, lambda bundle: (is_adult(bundle) & (
            has_item(LocalEvents.LW_BRIDGE_BEAN_PLANTED, bundle) | can_do_trick(Tricks.LW_BRIDGE, bundle))) | can_use(Items.HOVER_BOOTS,
                                                                                                                        bundle) | can_use(
            Items.LONGSHOT, bundle)),
        (Regions.ZR_FROM_SHORTCUT,
         lambda bundle: has_item(Items.SILVER_SCALE, bundle) | can_use(Items.IRON_BOOTS, bundle) | (can_do_trick(
             Tricks.LOST_WOOD_NAVI_DIVE, bundle) & is_child(bundle) & has_item(Items.BRONZE_SCALE,
                                                                                   bundle) & can_jump_slash(bundle))),
        (Regions.LW_BEYOND_MIDO,
         lambda bundle: is_child(bundle) | can_use(Items.SARIAS_SONG, bundle) | can_do_trick(Tricks.LW_MIDO_BACKFLIP,
                                                                                               bundle)),
    ...
    add_locations(Regions.LW_BEYOND_MIDO, world, [
        (Locations.LW_DEKU_SCRUB_NEAR_DEKU_THEATER_RIGHT,
         lambda bundle: is_child(bundle) & can_stun_deku(bundle) & can_afford_slot(Locations.LW_DEKU_SCRUB_NEAR_DEKU_THEATER_RIGHT, bundle)),
        (Locations.LW_DEKU_SCRUB_NEAR_DEKU_THEATER_LEFT,
         lambda bundle: is_child(bundle) & can_stun_deku(bundle) & can_afford_slot(Locations.LW_DEKU_SCRUB_NEAR_DEKU_THEATER_LEFT, bundle)),
        (Locations.LW_GS_ABOVE_THEATER, lambda bundle: is_adult(bundle) & can_get_nighttime_gs(bundle)
         & (has_item(LocalEvents.LW_THEATER_BEAN_PLANTED, bundle) & (can_attack(bundle))
              | (can_do_trick(Tricks.LW_GS_BEAN, bundle)
    ...
    connect_regions(Regions.LW_BEYOND_MIDO, world, [
        ...
        (Regions.DEKU_THEATER, lambda bundle: True_()),
    ...
    add_locations(Regions.LW_NEAR_SHORTCUTS_GROTTO, world, [
        (Locations.LW_NEAR_SHORTCUTS_GROTTO_CHEST, lambda bundle: True_()),
    ...
    add_locations(Regions.DEKU_THEATER, world, [
        (Locations.LW_DEKU_THEATER_SKULL_MASK,
         lambda bundle: is_child(bundle) & has_item(Events.CAN_BORROW_SKULL_MASK, bundle)),
        (Locations.LW_DEKU_THEATER_MASK_OF_TRUTH,
         lambda bundle: is_child(bundle) & has_item(Events.CAN_BORROW_MASK_OF_TRUTH, bundle)),
    ])
    # Connections
    ...
    add_locations(Regions.LW_SCRUBS_GROTTO, world, [
        (Locations.LW_DEKU_SCRUB_GROTTO_REAR,
         lambda bundle: can_stun_deku(bundle) & can_afford_slot(Locations.LW_DEKU_SCRUB_GROTTO_REAR, bundle)),
        (Locations.LW_DEKU_SCRUB_GROTTO_FRONT,
         lambda bundle: can_stun_deku(bundle) & can_afford_slot(Locations.LW_DEKU_SCRUB_GROTTO_FRONT, bundle)),
    ...
    add_locations(Regions.LW_BRIDGE_FROM_FOREST, world, [
        (Locations.LW_GIFT_FROM_SARIA, lambda bundle: True_())
    ])
    # Connections
