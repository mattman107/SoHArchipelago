...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.ZR_FRONT, world, [
        (Locations.ZR_GS_TREE, lambda bundle: is_child(bundle) & can_bonk_trees(bundle) &
    ...
    add_events(Regions.ZORA_RIVER, world, [
        (EventLocations.ZR_BUG_GRASS, Events.CAN_ACCESS_BUGS,
         lambda bundle: can_cut_shrubs(bundle) & (is_child(bundle) | can_use(Items.HOVER_BOOTS, bundle) | can_do_trick(Tricks.ZR_LOWER, bundle))),
    ...
    add_locations(Regions.ZORA_RIVER, world, [
        ...
        (Locations.ZR_FROGS_IN_THE_RAIN, lambda bundle: is_child(bundle) &
         can_use(Items.SONG_OF_STORMS, bundle)),
        (Locations.ZR_FROGS_ZELDAS_LULLABY, lambda bundle: is_child(bundle) &
         can_use(Items.ZELDAS_LULLABY, bundle)),
        (Locations.ZR_FROGS_EPONAS_SONG, lambda bundle: is_child(bundle) &
         can_use(Items.EPONAS_SONG, bundle)),
        (Locations.ZR_FROGS_SARIAS_SONG, lambda bundle: is_child(bundle) &
         can_use(Items.SARIAS_SONG, bundle)),
        (Locations.ZR_FROGS_SUNS_SONG, lambda bundle: is_child(bundle) &
         can_use(Items.SUNS_SONG, bundle)),
        (Locations.ZR_FROGS_SONG_OF_TIME, lambda bundle: is_child(bundle) &
         can_use(Items.SONG_OF_TIME, bundle)),
        (Locations.ZR_NEAR_OPEN_GROTTO_FREESTANDING_POH, lambda bundle: is_child(bundle) |
         can_use(Items.HOVER_BOOTS, bundle)
         | (is_adult(bundle)
             & can_do_trick(Tricks.ZR_LOWER, bundle))),
        (Locations.ZR_NEAR_DOMAIN_FREESTANDING_POH, lambda bundle: is_child(bundle) |
         can_use(Items.HOVER_BOOTS, bundle)
         | (is_adult(bundle)
        ...
        (Locations.ZR_NEAR_DOMAIN_GOSSIP_STONE_BIG_FAIRY,
         lambda bundle: can_use(Items.SONG_OF_STORMS, bundle)),
        (Locations.ZR_BENEATH_DOMAIN_RED_LEFT_RUPEE, lambda bundle: is_adult(bundle) &
         (has_item(Items.BRONZE_SCALE, bundle) |
          can_use(Items.IRON_BOOTS, bundle) |
          can_use(Items.BOOMERANG, bundle))),
        (Locations.ZR_BENEATH_DOMAIN_RED_MIDDLE_LEFT_RUPEE, lambda bundle: is_adult(bundle) &
         (has_item(Items.BRONZE_SCALE, bundle) |
          can_use(Items.IRON_BOOTS, bundle) |
          can_use(Items.BOOMERANG, bundle))),
        (Locations.ZR_BENEATH_DOMAIN_RED_MIDDLE_RIGHT_RUPEE, lambda bundle: is_adult(bundle) &
         (has_item(Items.BRONZE_SCALE, bundle) |
          can_use(Items.IRON_BOOTS, bundle) |
          can_use(Items.BOOMERANG, bundle))),
        (Locations.ZR_BENEATH_DOMAIN_RED_RIGHT_RUPEE, lambda bundle: is_adult(bundle) &
         (has_item(Items.BRONZE_SCALE, bundle) |
          can_use(Items.IRON_BOOTS, bundle) |
          can_use(Items.BOOMERANG, bundle))),
    ...
    connect_regions(Regions.ZR_BEHIND_WATERFALL, world, [
        (Regions.ZORA_RIVER, lambda bundle: True_()),
        (Regions.ZORAS_DOMAIN, lambda bundle: True_())
    ])
    ...
    add_locations(Regions.ZR_OPEN_GROTTO, world, [
        (Locations.ZR_OPEN_GROTTO_CHEST, lambda bundle: True_()),
    ...
    add_locations(Regions.ZR_FAIRY_GROTTO, world, [
        (Locations.ZR_FAIRY_GROTTO_FAIRY1, lambda bundle: True_()),
        (Locations.ZR_FAIRY_GROTTO_FAIRY2, lambda bundle: True_()),
        (Locations.ZR_FAIRY_GROTTO_FAIRY3, lambda bundle: True_()),
        (Locations.ZR_FAIRY_GROTTO_FAIRY4, lambda bundle: True_()),
        (Locations.ZR_FAIRY_GROTTO_FAIRY5, lambda bundle: True_()),
        (Locations.ZR_FAIRY_GROTTO_FAIRY6, lambda bundle: True_()),
        (Locations.ZR_FAIRY_GROTTO_FAIRY7, lambda bundle: True_()),
        (Locations.ZR_FAIRY_GROTTO_FAIRY8, lambda bundle: True_())
    ])
    # Connections
