...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_events(Regions.DEATH_MOUNTAIN_TRAIL, world, [
        (EventLocations.DMT_BEAN_PLANT_FAIRY, Events.CAN_ACCESS_FAIRIES, lambda bundle: is_child(bundle) & can_use(Items.MAGIC_BEAN,
         bundle) & can_use(Items.SONG_OF_STORMS, bundle) & (has_explosives(bundle) | has_item(Items.GORONS_BRACELET, bundle))),
        (EventLocations.DMT_BEAN_PATCH, LocalEvents.DMT_BEAN_PLANTED, lambda bundle: is_child(bundle) & can_use(
            Items.MAGIC_BEAN, bundle) & (has_explosives(bundle) | has_item(Items.GORONS_BRACELET, bundle))),
    ])
    # Locations
    add_locations(Regions.DEATH_MOUNTAIN_TRAIL, world, [
        (Locations.DMT_CHEST, lambda bundle: blast_or_smash(bundle) | (can_do_trick(
            Tricks.DMT_BOMBABLE, bundle) & is_child(bundle) & has_item(Items.GORONS_BRACELET, bundle))),
        (Locations.DMT_FREESTANDING_POH, lambda bundle: take_damage(bundle) | can_use(Items.HOVER_BOOTS, bundle) | (is_adult(bundle)
        ...
        (Locations.DMT_RED_RUPEE_UNDER_BOULDER,
         lambda bundle: is_child(bundle) & blast_or_smash(bundle)),
        (Locations.DMT_BEAN_SPROUT_FAIRY1, lambda bundle: is_child(bundle) & can_use(Items.MAGIC_BEAN, bundle) & can_use(
            Items.SONG_OF_STORMS, bundle) & (has_explosives(bundle) | has_item(Items.GORONS_BRACELET, bundle))),
        (Locations.DMT_BEAN_SPROUT_FAIRY2, lambda bundle: is_child(bundle) & can_use(Items.MAGIC_BEAN, bundle) & can_use(
            Items.SONG_OF_STORMS, bundle) & (has_explosives(bundle) | has_item(Items.GORONS_BRACELET, bundle))),
        (Locations.DMT_BEAN_SPROUT_FAIRY3, lambda bundle: is_child(bundle) & can_use(Items.MAGIC_BEAN, bundle) & can_use(
            Items.SONG_OF_STORMS, bundle) & (has_explosives(bundle) | has_item(Items.GORONS_BRACELET, bundle))),
    ...
    connect_regions(Regions.DEATH_MOUNTAIN_TRAIL, world, [
        (Regions.KAK_BEHIND_GATE, lambda bundle: True_()),
        (Regions.GORON_CITY, lambda bundle: True_()),
        (Regions.DEATH_MOUNTAIN_SUMMIT, lambda bundle: blast_or_smash(bundle) | (is_adult(bundle) & ((has_item(LocalEvents.DMT_BEAN_PLANTED, bundle)
         & has_item(Items.GORONS_BRACELET, bundle)) | (can_use(Items.HOVER_BOOTS, bundle) & can_do_trick(Tricks.DMT_CLIMB_HOVERS, bundle))))),
    ...
    add_locations(Regions.DEATH_MOUNTAIN_SUMMIT, world, [
        (Locations.DMT_TRADE_BROKEN_SWORD, lambda bundle: is_adult(
            bundle) & can_use(Items.BROKEN_GORONS_SWORD, bundle)),
        (Locations.DMT_TRADE_EYEDROPS, lambda bundle: is_adult(
            bundle) & can_use(Items.WORLDS_FINEST_EYEDROPS, bundle)),
        (Locations.DMT_TRADE_CLAIM_CHECK, lambda bundle: is_adult(
            bundle) & can_use(Items.CLAIM_CHECK, bundle)),
        (Locations.DMT_GS_FALLING_ROCKS_PATH, lambda bundle: is_adult(bundle) & at_night(bundle) & (can_use(
            Items.MEGATON_HAMMER, bundle) | can_do_trick(Tricks.DMT_UPPER_GS, bundle)) & can_get_nighttime_gs(bundle)),
    ...
    connect_regions(Regions.DMT_OWL_FLIGHT, world, [
        (Regions.KAK_IMPAS_ROOFTOP, lambda bundle: True_())
    ])
    ...
    add_locations(Regions.DMT_COW_GROTTO, world, [
        ...
        (Locations.DMT_COW_GROTTO_LEFT_HEART, lambda bundle: True_()),
        (Locations.DMT_COW_GROTTO_MIDDLE_LEFT_HEART, lambda bundle: True_()),
        (Locations.DMT_COW_GROTTO_MIDDLE_RIGHT_HEART, lambda bundle: True_()),
        (Locations.DMT_COW_GROTTO_RIGHT_HEART, lambda bundle: True_()),
        (Locations.DMT_COW_GROTTO_RUPEE1, lambda bundle: True_()),
        (Locations.DMT_COW_GROTTO_RUPEE2, lambda bundle: True_()),
        (Locations.DMT_COW_GROTTO_RUPEE3, lambda bundle: True_()),
        (Locations.DMT_COW_GROTTO_RUPEE4, lambda bundle: True_()),
        (Locations.DMT_COW_GROTTO_RUPEE5, lambda bundle: True_()),
        (Locations.DMT_COW_GROTTO_RUPEE6, lambda bundle: True_()),
        (Locations.DMT_COW_GROTTO_RED_RUPEE, lambda bundle: True_()),
    ...
    add_locations(Regions.DMT_STORMS_GROTTO, world, [
        (Locations.DMT_STORMS_GROTTO_CHEST, lambda bundle: True_()),
