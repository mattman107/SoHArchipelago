...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.KAKARIKO_VILLAGE, world, [
        (Regions.HYRULE_FIELD, lambda bundle: True, SOHOverworldEntranceNames.KAKARIKO_VILLAGE_FRONT_GATE, SOHEntranceGroups.OVERWORLD | SOHEntranceGroups.BOTH_AGE),
        ...
        (Regions.THE_GRAVEYARD, lambda bundle: True, SOHOverworldEntranceNames.KAKARIKO_VILLAGE_SOUTHEAST_EXIT, SOHEntranceGroups.OVERWORLD | SOHEntranceGroups.BOTH_AGE),
    ...
    connect_regions(Regions.KAK_BEHIND_GATE, world, [
        ...
        (Regions.DEATH_MOUNTAIN, lambda bundle: True, SOHOverworldEntranceNames.KAKARIKO_VILLAGE_GUARD_GATE, SOHEntranceGroups.OVERWORLD | SOHEntranceGroups.BOTH_AGE)
    ])
    ...
    connect_regions(Regions.KAK_WELL, world, [
        ...
        (Regions.BOTTOM_OF_THE_WELL_ENTRYWAY, lambda bundle: is_child(bundle) or (has_item(Events.DRAIN_WELL, bundle) and world.options.shuffle_dungeon_entrances.value >
         0), SOHDungeonEntranceNames.BOTTOM_OF_THE_WELL_DUNGEON_ENTRANCE, SOHEntranceGroups.DUNGEON_ENTRANCE | SOHEntranceGroups.ANY_AGE, EntranceType.TWO_WAY)
    ])
