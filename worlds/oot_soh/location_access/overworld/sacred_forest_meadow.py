...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.SFM_ENTRYWAY, world, [
        (Regions.LW_BEYOND_MIDO, lambda bundle: True, SOHOverworldEntranceNames.SACRED_FOREST_MEADOW_SOUTH_EXIT, SOHEntranceGroups.OVERWORLD | SOHEntranceGroups.BOTH_AGE),
