...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.DESERT_COLOSSUS, world, [
        ...
        (Regions.WASTELAND_NEAR_COLOSSUS, lambda bundle: True, SOHOverworldEntranceNames.DESERT_COLOSSUS_EAST_EXIT, SOHEntranceGroups.OVERWORLD | SOHEntranceGroups.ANY_AGE),
