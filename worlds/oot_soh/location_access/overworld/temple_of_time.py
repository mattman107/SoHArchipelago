...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.TOT_ENTRANCE, world, [
        (Regions.MARKET, lambda bundle: True, SOHOverworldEntranceNames.TEMPLE_OF_TIME_EXTERIOR_DAY_GOSSIP_STONE_EXIT, SOHEntranceGroups.OVERWORLD | SOHEntranceGroups.BOTH_AGE),
