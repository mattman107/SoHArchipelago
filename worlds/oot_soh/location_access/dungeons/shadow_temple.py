...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.SHADOW_TEMPLE_ENTRYWAY, world, [
        (Regions.SHADOW_TEMPLE_BEGINNING, lambda bundle: (can_do_trick(Tricks.LENS_SHADOW, bundle) | can_use(
            Items.LENS_OF_TRUTH, bundle)) & (can_use(Items.HOVER_BOOTS, bundle) | can_use(Items.HOOKSHOT, bundle))),
        (Regions.GRAVEYARD_WARP_PAD_REGION, lambda bundle: True_())
    ])
    ...
    connect_regions(Regions.SHADOW_TEMPLE_BEGINNING, world, [
        (Regions.SHADOW_TEMPLE_ENTRYWAY, lambda bundle: True_()),
    ...
    connect_regions(Regions.SHADOW_TEMPLE_FIRST_BEAMOS, world, [
        (Regions.SHADOW_TEMPLE_HUGE_PIT, lambda bundle: has_explosives(bundle) & is_adult(
            bundle) & small_keys(Items.SHADOW_TEMPLE_SMALL_KEY, 1, bundle)),
        (Regions.SHADOW_TEMPLE_BEYOND_BOAT, lambda bundle: False_()),
    ])
    ...
    add_locations(Regions.SHADOW_TEMPLE_HUGE_PIT, world, [
        ...
        (Locations.SHADOW_TEMPLE_GS_LIKE_LIKE_ROOM,
         lambda bundle: can_jump_slash_except_hammer(bundle)),
        (Locations.SHADOW_TEMPLE_GS_FALLING_SPIKES_ROOM, lambda bundle: can_use(Items.HOOKSHOT, bundle) | (can_do_trick(Tricks.SHADOW_UMBRELLA_GS, bundle) & can_use(
            Items.HOVER_BOOTS, bundle) & can_standing_shield(bundle) & can_use(Items.MASTER_SWORD, bundle)) | (is_adult(bundle) & can_ground_jump(bundle))),
        (Locations.SHADOW_TEMPLE_GS_SINGLE_GIANT_POT, lambda bundle: small_keys(Items.SHADOW_TEMPLE_SMALL_KEY, 2, bundle) & ((can_do_trick(
            Tricks.LENS_SHADOW_PLATFORM, bundle) & can_do_trick(Tricks.LENS_SHADOW, bundle)) | can_use(Items.LENS_OF_TRUTH, bundle)) & can_use(Items.HOOKSHOT, bundle)),
        (Locations.SHADOW_TEMPLE_FALLING_SPIKES_POT1,
         lambda bundle: can_break_pots(bundle)),
        (Locations.SHADOW_TEMPLE_FALLING_SPIKES_POT2,
         lambda bundle: can_break_pots(bundle)),
        (Locations.SHADOW_TEMPLE_FALLING_SPIKES_POT3, lambda bundle: can_break_pots(bundle) & (can_do_trick(Tricks.SHADOW_UMBRELLA_HOVER, bundle)
         & can_use(Items.HOVER_BOOTS, bundle)) | can_do_trick(Tricks.SHADOW_UMBRELLA_CLIP, bundle) | has_item(Items.GORONS_BRACELET, bundle)),
        (Locations.SHADOW_TEMPLE_FALLING_SPIKES_POT4, lambda bundle: can_break_pots(bundle) & (can_do_trick(Tricks.SHADOW_UMBRELLA_HOVER, bundle)
         & can_use(Items.HOVER_BOOTS, bundle)) | can_do_trick(Tricks.SHADOW_UMBRELLA_CLIP, bundle) | has_item(Items.GORONS_BRACELET, bundle)),
        (Locations.SHADOW_TEMPLE_INVISIBLE_BLADES_LEFT_HEART, lambda bundle: (can_use(
            Items.SONG_OF_TIME, bundle) & is_adult(bundle)) | can_use(Items.BOOMERANG, bundle)),
    ...
    connect_regions(Regions.SHADOW_TEMPLE_HUGE_PIT, world, [
        (Regions.SHADOW_TEMPLE_WIND_TUNNEL, lambda bundle: ((can_do_trick(Tricks.LENS_SHADOW_PLATFORM, bundle) & can_do_trick(Tricks.LENS_SHADOW, bundle)) | can_use(Items.LENS_OF_TRUTH, bundle)) & (
            can_use(Items.HOOKSHOT, bundle) | (can_do_trick(Tricks.GROUND_JUMP_HARD, bundle) & can_ground_jump(bundle))) & small_keys(Items.SHADOW_TEMPLE_SMALL_KEY, 3, bundle)),
    ])
    ...
    add_locations(Regions.SHADOW_TEMPLE_WIND_TUNNEL, world, [
        ...
        (Locations.SHADOW_TEMPLE_GS_NEAR_SHIP, lambda bundle: can_use(
            Items.LONGSHOT, bundle) & small_keys(Items.SHADOW_TEMPLE_SMALL_KEY, 4, bundle)),
        ...
        (Locations.SHADOW_TEMPLE_SCARECROW_NEAR_SHIP_NORTH_HEART, lambda bundle: can_use(
            Items.DISTANT_SCARECROW, bundle) & small_keys(Items.SHADOW_TEMPLE_SMALL_KEY, 4, bundle)),
    ...
    connect_regions(Regions.SHADOW_TEMPLE_WIND_TUNNEL, world, [
        (Regions.SHADOW_TEMPLE_BEYOND_BOAT, lambda bundle: can_jump_slash_except_hammer(bundle) & can_use(
            Items.ZELDAS_LULLABY, bundle) & small_keys(Items.SHADOW_TEMPLE_SMALL_KEY, 4, bundle)),
    ])
    ...
    add_locations(Regions.SHADOW_TEMPLE_BEYOND_BOAT, world, [
        ...
        (Locations.SHADOW_TEMPLE_AFTER_BOAT_POT2,
         lambda bundle: can_break_pots(bundle)),
        (Locations.SHADOW_TEMPLE_AFTER_BOAT_POT3, lambda bundle: can_break_pots(bundle) & (can_use(Items.FAIRY_BOW, bundle) | can_use(
            Items.DISTANT_SCARECROW, bundle) | (can_do_trick(Tricks.SHADOW_STATUE, bundle) & can_use(Items.BOMBCHUS_5, bundle)))),
        (Locations.SHADOW_TEMPLE_AFTER_BOAT_POT4, lambda bundle: can_break_pots(bundle) & (can_use(Items.FAIRY_BOW, bundle) | can_use(
            Items.DISTANT_SCARECROW, bundle) | (can_do_trick(Tricks.SHADOW_STATUE, bundle) & can_use(Items.BOMBCHUS_5, bundle)))),
        ...
        (Locations.SHADOW_TEMPLE_AFTER_SHIP_UPPER_RIGHT_HEART,
         lambda bundle: can_use(Items.DISTANT_SCARECROW, bundle)),
        (Locations.SHADOW_TEMPLE_AFTER_SHIP_LOWER_HEART, lambda bundle: (can_use(Items.FAIRY_BOW, bundle) | can_use(Items.DISTANT_SCARECROW, bundle) | (can_do_trick(Tricks.SHADOW_STATUE,
         bundle) & can_use(Items.BOMBCHUS_5, bundle))) & can_use(Items.SONG_OF_TIME, bundle) | (can_use(Items.DISTANT_SCARECROW, bundle) & can_use(Items.HOVER_BOOTS, bundle)))
    ])
    # Connections
    connect_regions(Regions.SHADOW_TEMPLE_BEYOND_BOAT, world, [
        (Regions.SHADOW_TEMPLE_BOSS_ENTRYWAY, lambda bundle: (can_use(Items.FAIRY_BOW, bundle) | can_use(Items.DISTANT_SCARECROW, bundle) | (can_do_trick(
            Tricks.SHADOW_STATUE, bundle) & can_use(Items.BOMBCHUS_5, bundle))) & small_keys(Items.SHADOW_TEMPLE_SMALL_KEY, 5, bundle) & can_use(Items.HOVER_BOOTS, bundle)),
    ])
    ...
    connect_regions(Regions.SHADOW_TEMPLE_BOSS_ROOM, world, [
        (Regions.SHADOW_TEMPLE_BOSS_ENTRYWAY, lambda bundle: False_()),
