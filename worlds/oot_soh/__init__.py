...
class SohWorld(World):
    ...
    def fill_slot_data(self) -> dict[str, Any]:
        ...
        return {
            ...
            "shuffle_overworld_entrances": self.options.shuffle_overworld_entrances.value,
            "shuffle_owl_drops": self.options.shuffle_owl_drops.value,
            "shuffle_warp_songs": self.options.shuffle_warp_songs.value,
            "shuffle_overworld_spawns": self.options.shuffle_overworld_spawns.value,
            "mixed_entrance_pools": self.options.mixed_entrance_pools.value,
            "mix_dungeon_entrances": self.options.mix_dungeon_entrances.value,
            ...
            "mix_boss_entrances": self.options.mix_boss_entrances.value,
