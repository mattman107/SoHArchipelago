...
class TestHearts(SohTestBase):
    ...
    def test_heart_counts(self):
        ...
        self.assertTrue(self.multiworld.state.soh_effective_health[self.player] == 6)  # type: ignore
        ...
        self.assertTrue(self.multiworld.state.soh_effective_health[self.player] == 8)  # type: ignore
        ...
        self.assertTrue(self.multiworld.state.soh_effective_health[self.player] == 10)  # type: ignore
        ...
        self.assertTrue(self.multiworld.state.soh_effective_health[self.player] == 12)  # type: ignore
